...
public class CSVReader {
    ...
    // Directory "relativa" del file di appoggio dove copiare le configurazioni dei
    // gruppi fornite
    ...
    public List<List<String>> csv_gruppi(Part part, String path) throws IOException {
        ...
        List<List<String>> confGruppi = new ArrayList<List<String>>();

        // Unione della directory del contesto con la directory relativa --> PATH esatto
        // del file
        String dir = path + CSV_GRUPPI_FILE;

        // Copio il contenuto del file di configurazione fornito dall'admin in
        // gruppi.csv
        ...
        try (Reader reader = Files.newBufferedReader(Paths.get(dir));) {
            ...
            for (CSVRecord csvRecord : records) {
                confGruppi.add(new ArrayList<String>());
