...
public interface AulaDao {
    ...
    // Aula getAulaByPosizione(String edificio, String luogo, int piano, String
    // nome) throws DataException;
    ...
    // List<Aula> getListaAuleByPreseElettriche(int numeroPreseElettriche) throws
    // DataException;
